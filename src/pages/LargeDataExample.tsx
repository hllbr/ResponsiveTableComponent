    ...
    <div className="h-screen overflow-hidden flex flex-col p-6">
      <div className="flex-shrink-0">
        ...
        <p className="text-gray-600 mt-2">
          Çok veri ile scroll davranışını test edin (PageSize:{" "}
          {currentData.pageSize}, Total: {currentData.totalRows}). Farklı
          boyutlarda veri seti ile tablo performansını ve bileşen
          kombinasyonlarını gözlemleyebilirsiniz. Kontroller sidebar'da bulunur.
        </p>
      </div>
